  ...
  return (
    ...
    >
      <div className="relative overflow-hidden" style={{ aspectRatio: '16 / 10' }}>
        ...
        />
        <span className="absolute left-2.5 top-2.5 font-mono text-[9px] max-md:text-[10px] tabular-nums text-brass">
      ...
      <div className={cn('flex flex-col gap-1', compact ? 'p-2.5' : 'p-3.5')}>
        ...
        <div className="flex items-center justify-between gap-2">
          <span className="truncate font-mono text-[9px] max-md:text-[10px] uppercase tracking-[0.13em] text-mist">
            {project.category}
          </span>
          <span className="shrink-0 font-mono text-[9px] max-md:text-[10px] tabular-nums text-mist">{project.year}</span>
        </div>
      </div>
